...
export default defineComponent({
  ...
  setup () {
    const testData = {
      ...
      // 页面上面一个个组件的属性
      components: [
        {id: '123212', name: 'l-text', props: { text: 'hello', top: '0', left: '20px'}},
        ...
        // 这是一个链接
        {id: '3456', name: 'l-text', props: { backgroundColor: "#1890ff", color: "#ffffff", text: "按钮内容",  width: "100px", actionType: "to", url: "http://www.baidu.com", top: '200px', left: '150px',
        }}
      ]
    }
    return {
